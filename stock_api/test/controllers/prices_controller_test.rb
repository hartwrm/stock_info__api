...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { company_id: @price.company_id, price: @price.price } }, as: :json
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { company_id: @price.company_id, price: @price.price } }, as: :json
    assert_response 200
  end
